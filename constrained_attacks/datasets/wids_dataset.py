...
class WidsDataset(DownloadFileDataset):
    def __init__(
        ...
        data_url = (
            "https://uniluxembourg-my.sharepoint.com/:x:/g/personal/thibault_simonetto_uni_lu/ESKij8CqW6dAlIe3bW-6rk0BCyDZ7B1gLYI3OTLdlH2wGg?download=1"
        )
        metadata_path = f"{MLC_DATA_PATH}/wids/wids_metadata.csv"
        metadata_url = (
            "https://uniluxembourg-my.sharepoint.com/:x:/g/personal/thibault_simonetto_uni_lu/EWZgana5BVJNgvCiM1I-Y7MBhXOw7MrxyjGWMg2FRnMCBA?download=1"
        )
